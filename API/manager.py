...
from src import api, db, ma, create_app, configs, bp, security, admin, celery, serializer_helper, sentry, sms, url_shortener, limiter, jwt, razor
...
extensions = [api, db, ma, security, admin, celery, serializer_helper, sentry,
